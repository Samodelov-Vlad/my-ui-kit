...
function re(e, t, n) {
	for (let n = 0; n < t.length; n++) F(e, t[n]);
	for (let r = t.length - 1; r >= 0; r--) e.splice(n, 0, t[r]);
}
var I = (e) => e == null || e === "" ? null : e;
function L(e) {
	return e != null && e !== "";
}
function R(e) {
...
var ie = (e) => e != null && typeof e.toString == "function" ? e.toString() : null, ae = (e, t, n = !1) => e == null ? t == null ? 0 : -1 : t == null ? 1 : (typeof e == "object" && e.toNumber && (e = e.toNumber()), typeof t == "object" && t.toNumber && (t = t.toNumber()), !n || typeof e != "string" ? e > t ? 1 : e < t ? -1 : 0 : e.localeCompare(t)), oe = class {
	constructor() {
...
function B(e) {
	...
	return i && L(i) ? r = i() : n && (r = n.ownerDocument), r && L(r) ? r : document;
}
function me(e) {
	let t = z(e);
...
var Nt = class {
	...
	addEventListener(e, t, n) {
		this.localEventService ||= new oe(), this.localEventService.addEventListener(e, t, n);
	}
...
function Zn(e) {
	...
	if (!r || R(r)) return t.getDefaultRowHeight();
...
var Tr = [
	...
	constructor(e, t, n, r) {
		super(), this.colDef = e, this.userProvidedColDef = t, this.colId = n, this.primary = r, this.isColumn = !0, this.instanceId = Cr(), this.autoHeaderHeight = null, this.sortDef = Or(), this._wasSortExplicitlyRemoved = !1, this.moving = !1, this.resizing = !1, this.menuVisible = !1, this.formulaRef = null, this.lastLeftPinned = !1, this.firstRightPinned = !1, this.filterActive = !1, this.colEventSvc = new oe(), this.tooltipEnabled = !1, this.rowGroupActive = !1, this.pivotActive = !1, this.aggregationActive = !1, this.flex = null, this.colIdSanitised = ue(n);
	}
	destroy() {
	...
	initDotNotation() {
		...
		this.fieldContainsDots = L(t) && t.includes(".") && !r, this.tooltipFieldContainsDots = L(n) && n.includes(".") && !r;
	}
	initMinAndMaxWidths() {
		let e = this.colDef;
	...
	getColSpan(e) {
		if (R(this.colDef.colSpan)) return 1;
		let t = this.createBaseColDefParams(e), n = this.colDef.colSpan(t);
		return Math.max(n, 1);
	}
	getRowSpan(e) {
		if (R(this.colDef.rowSpan)) return 1;
...
var li = (e, t) => (n, r) => {
	...
	return e && (e[n] !== void 0 && (i.value1 = e[n], a = !0), L(r) && e[r] !== void 0 && (i.value2 = e[r], a = !0)), !a && t && (t[n] !== void 0 && (i.value1 = t[n]), L(r) && t[r] !== void 0 && (i.value2 = t[r])), i;
};
function ui(e) {
...
function Wa(e, t) {
	return e?.beanName === "gridDestroySvc" ? -1 : +(t?.beanName === "gridDestroySvc");
}
function Ga(e, t) {
...
function Ka(e, t) {
	switch (e.rowPinned) {
		...
		case "bottom":
			...
			break;
		default:
			if (L(t.rowPinned)) return t.rowPinned !== "top";
			break;
	}
...
var bo = class extends H {
	...
	handleKeyDown(e) {
		...
		switch (e.key) {
			case Y.LEFT: t = "LEFT";
			case Y.RIGHT:
				L(t) || (t = "RIGHT"), n.navigateHorizontally(t, !1, e) && e.preventDefault();
				break;
			case Y.UP: t = "UP";
			case Y.DOWN:
				L(t) || (t = "DOWN"), n.navigateVertically(t, e) && e.preventDefault();
				break;
			default: return;
		}
	}
...
var wo = class extends H {
	...
	setLeftFirstTime() {
		let { gos: e, colAnimation: t } = this.beans, n = e.get("suppressColumnMoveAnimation"), r = L(this.columnOrGroup.getOldLeft());
	...
	setLeft(e) {
		if (L(e) && (this.eCell.style.left = `${e}px`), J(this.columnOrGroup)) {
...
function Do(e, t, n, r) {
	return R(e) ? [] : Ao(e.headerClass, e, t, n, r);
}
function Oo(e, t, n) {
...
var Io = 0, Lo = class extends H {
	...
	getRowCount() {
		return this.groupsRowCtrls.length + +!!this.columnsRowCtrl + +!!this.filtersRowCtrl;
	}
...
var $c = 7, el = 100, tl = el / 2, nl = 5, rl = 100, il = class extends H {
	constructor(e) {
		super(), this.pinned = e, this.needToMoveLeft = !1, this.needToMoveRight = !1, this.lastMovedInfo = null, this.isCenterContainer = !L(e);
	}
	postConstruct() {
		this.beans.ctrlsSvc.whenReady(this, (e) => {
	...
	onDragging(e = this.lastDraggingEvent, t = !1, n = !1, r = !1) {
		...
		if (this.lastDraggingEvent = e, !e || !r && R(e.hDirection)) return;
		let s = Zc({
			x: e.x,
			pinned: this.pinned,
			gos: i,
...
var ul = class extends H {
	...
	moveColumns(e, t, n, r = !0) {
		...
		this.doesMovePassRules(l, t) && (re(i.getCols(), l, t), o.refresh(n), s.dispatchEvent({
			type: "columnMoved",
			columns: l,
...
function pl(e, t) {
	...
	let i = [];
	for (let e of t) n.indexOf(e) >= 0 && (i.push(e), F(n, e));
...
var Gl = {
	...
	beans: [class extends H {
		...
		createColumnGroup(e, t, n, r, i) {
			...
			return s && s.getProvidedColumnGroup() !== e && (s = null), L(s) ? s.reset() : (s = new fi(e, a, o, r), i || this.createBean(s)), s;
		}
		mapOldGroupsById(e) {
			let t = {}, n = (e) => {
...
function Kl(e, t, n) {
	...
	let _ = (r, o, s, c, l) => {
		...
		for (let e of c) {
			...
			let n = d(t);
			n ? (_(n, e, g, v, !1), F(h, n)) : (x.push(e), S += 1);
		}
	...
	return (y.length > 0 || L(t.defaultState)) && (b = v(y, u?.getPivotResultCols()?.list ?? [], (e) => u?.getPivotResultCol(e) ?? null).unmatchedCount), c?.finish(), b === 0;
}
function ql(e, t) {
...
function Jl(e) {
	...
	if (R(t.getColDefCols()) || !t.isAlive()) return [];
...
var Tu = [
	...
	getDefaultDataTypes() {
		...
		return {
			...
			text: {
				baseDataType: "text",
				valueParser: (e) => e.newValue === "" ? null : ie(e.newValue),
...
var Ru = {
	...
	getColsWithinViewport(e) {
		...
		let t = (e) => {
			let t = e.getLeft();
			return L(t) && t > this.viewportLeft;
...
`, document.head, `googleFont:${e}`, void 0, 0, t);
	...
	let t = "";
	for (let n of [...Object.keys(ff), ...Object.keys(pf)]) {
		let r = hf(n, e.strokeWidth);
...
`;
...
}), xf = cf().withPart(lf).withPart(df).withPart(gf).withPart(bf).withPart(yf).withPart(af).withParams({ fontFamily: [
	...
	noWarn: r,
	cacheDefault: i
}), Cf = Sf("cellHorizontalPadding", "length", 16), wf = Sf("indentationLevel", "length", 0, !0, !0), Tf = Sf("rowGroupIndentSize", "length", 0), Ef = Sf("rowHeight", "length", 42), Df = Sf("headerHeight", "length", 48), Of = Sf("rowBorderWidth", "border", 1), kf = Sf("pinnedRowBorderWidth", "border", 1), Af = Sf("headerRowBorderWidth", "border", 1);
function jf(e, t) {
...
var Mf = class extends Jd {
	initVariables() {
		this.addManagedPropertyListener("rowHeight", () => this.refreshRowHeightVariable()), this.getSizeEl(Ef), this.getSizeEl(Df), this.getSizeEl(Of), this.getSizeEl(kf), this.refreshRowBorderWidthVariable();
	}
	...
	getDefaultCellHorizontalPadding() {
		return this.getCSSVariablePixelValue(Cf);
	}
	getCellPaddingLeft() {
		let e = this.getDefaultCellHorizontalPadding(), t = this.getCSSVariablePixelValue(wf), n = this.getCSSVariablePixelValue(Tf);
		return e - 1 + n * t;
	}
	getCellPadding() {
	...
	refreshRowBorderWidthVariable() {
		let e = this.getCSSVariablePixelValue(Of);
	...
	getAdditionalCss() {
		...
		return e.set("core", [Zd]), jf(e, Array.from(yn())), e;
	}
	getDefaultTheme() {
		return xf;
	}
	...
	constructor() {
		super(...arguments), this.beanName = "eventSvc", this.eventServiceType = "global", this.globalSvc = new oe();
	}
	addListener(e, t, n) {
...
var If = class extends H {
	...
	navigateVertically(e, t) {
		...
		if (!i) return !1;
		let { headerRowIndex: a } = i, o = i.column, s = co(this.beans), c = this.getHeaderRowType(a), l = r.headerGroupRowCount, { headerRowIndex: u, column: d, headerRowIndexWithoutSpan: f } = e === "UP" ? Lf(c, o, a) : Rf(o, a, l), p = !1;
	...
	focusNextHeaderRow(e, t, n) {
		...
		let { column: l, headerRowIndex: u } = Ff(this.beans, a, o);
...
var zf = class extends H {
	...
	isRowFocused(e, t) {
		return this.focusedCell == null ? !1 : this.focusedCell.rowIndex === e && this.focusedCell.rowPinned === I(t);
	}
	focusOverlay(e) {
	...
	getGridBodyTabTarget(e) {
		...
		return this.gos.get("headerHeight") === 0 || no(this.beans) ? this.getGridViewTabTarget({ column: t }) : t ? Ff(this.beans, t, 0) : null;
	}
...
}, Hf = /* @__PURE__ */ "columnEverythingChanged.newColumnsLoaded.columnPivotModeChanged.pivotMaxColumnsExceeded.columnRowGroupChanged.expandOrCollapseAll.columnPivotChanged.gridColumnsChanged.columnValueChanged.columnMoved.columnVisible.columnPinned.columnGroupOpened.columnResized.displayedColumnsChanged.virtualColumnsChanged.columnHeaderMouseOver.columnHeaderMouseLeave.columnHeaderClicked.columnHeaderContextMenu.asyncTransactionsFlushed.rowGroupOpened.rowDataUpdated.pinnedRowDataChanged.pinnedRowsChanged.rangeSelectionChanged.cellSelectionChanged.chartCreated.chartRangeSelectionChanged.chartOptionsChanged.chartDestroyed.toolPanelVisibleChanged.toolPanelSizeChanged.modelUpdated.cutStart.cutEnd.pasteStart.pasteEnd.fillStart.fillEnd.cellSelectionDeleteStart.cellSelectionDeleteEnd.rangeDeleteStart.rangeDeleteEnd.undoStarted.undoEnded.redoStarted.redoEnded.cellClicked.cellDoubleClicked.cellMouseDown.cellContextMenu.cellValueChanged.cellEditRequest.rowValueChanged.headerFocused.cellFocused.rowSelected.selectionChanged.tooltipShow.tooltipHide.cellKeyDown.cellMouseOver.cellMouseOut.filterChanged.filterModified.filterUiChanged.filterOpened.floatingFilterUiChanged.advancedFilterBuilderVisibleChanged.sortChanged.virtualRowRemoved.rowClicked.rowDoubleClicked.gridReady.gridPreDestroyed.gridSizeChanged.viewportChanged.firstDataRendered.dragStarted.dragStopped.dragCancelled.rowEditingStarted.rowEditingStopped.cellEditingStarted.cellEditingStopped.bodyScroll.bodyScrollEnd.paginationChanged.componentStateChanged.storeRefreshed.stateUpdated.columnMenuVisibleChanged.contextMenuVisibleChanged.rowDragEnter.rowDragMove.rowDragLeave.rowDragEnd.rowDragCancel.findChanged.rowResizeStarted.rowResizeEnded.columnsReset.bulkEditingStarted.bulkEditingStopped.batchEditingStarted.batchEditingStopped".split("."), Uf = /* @__PURE__ */ new Set([
	"gridPreDestroyed",
	"fillStart",
	"pasteStart"
]), Wf = Hf.reduce((e, t) => (e[t] = gr(t), e), {}), Gf = {
	...
	cellEditor: ({ cellEditor: e, editable: t, groupRowEditable: n }) => t || n ? typeof e == "string" ? Gf[e] ?? "CustomEditor" : "CustomEditor" : null,
	cellRenderer: ({ cellRenderer: e }) => typeof e == "string" ? Gf[e] : null,
	cellStyle: "CellStyle",
	...
	filter: ({ filter: e }) => e && typeof e != "string" && typeof e != "boolean" ? "CustomFilter" : typeof e == "string" ? Gf[e] ?? "ColumnFilter" : "ColumnFilter",
...
}, Jf = 0, Yf = 0, Xf = "__ag_grid_instance", Zf = class extends H {
	constructor() {
		super(...arguments), this.beanName = "gos", this.domDataKey = "__AG_" + Math.random().toString(), this.instanceId = Yf++, this.gridReadyFired = !1, this.queueEvents = [], this.propEventSvc = new oe(), this.globalEventHandlerFactory = (e) => (t, n) => {
			if (!this.isAlive()) return;
			let r = Uf.has(t);
			if (r && !e || !r && e || !Qf(t)) return;
			let i = (e, t) => {
				let n = Wf[e], r = this.gridOptions[n];
	...
	validateGridOptions(e) {
		this.validateOptions(e, qf), this.validation?.processGridOptions(e);
	}
	validateColDef(e, t, n) {
		(n || !this.beans.dataTypeSvc?.isColPendingInference(t)) && (this.validateOptions(e, Kf), this.validation?.validateColDef(e));
	}
	...
	setInstanceDomData(e) {
		e[Xf] = this.instanceId;
	}
	isElementInThisInstance(e) {
		let t = e;
		for (; t;) {
			let e = t[Xf];
			if (L(e)) return e === this.instanceId;
			t = t.parentElement;
		}
		return !1;
	}
...
var tp = class extends Qi {
	...
	workOutTemplate(e, t) {
		...
		return r ? r?.trim ? r.trim() : r : ep(!!n?.active, t);
	}
	init(e) {
		this.params = e;
		let { sortSvc: t, touchSvc: n, rowNumbersSvc: r, userCompFactory: i } = this.beans, a = t?.getSortIndicatorSelector();
		this.currentTemplate = this.workOutTemplate(e, !!a), this.setTemplate(this.currentTemplate, a ? [a] : void 0), this.eLabel && (this.mouseListener ??= this.createManagedBean(new $f(e.column, this.eLabel))), n?.setupForHeader(this), this.setMenu(), this.setupSort(), this.setupColumnRefIndicator(), r?.setupForHeader(this), this.setupFilterIcon(), this.setupFilterButton(), this.workOutInnerHeaderComponent(i, e), this.setDisplayName(e);
	}
	...
	constructor() {
		super(rp), this.agOpened = null, this.agClosed = null, this.agLabel = null, this.isLoadingInnerComponent = !1;
	}
	init(e) {
	...
	setupLabel(e) {
		...
		L(t) && !a && (this.agLabel.textContent = le(t)), n.getColGroupDef()?.suppressStickyLabel || this.createManagedBean(new np(this.getGui(), n));
	}
	destroy() {
	...
	version: U,
	userComponents: { agColumnHeader: tp },
	icons: {
		menu: "menu",
		menuAlt: "menu-alt"
	}
	...
	version: U,
	userComponents: { agColumnGroupHeader: ip },
	icons: {
	...
	beans: [class extends H {
		...
		setupForHeader(e) {
			...
			let c = e.shouldSuppressMenuHide(), l = c && L(a) && i.enableMenu, u = !!r?.isHeaderContextMenuEnabled(i.column), d = lp(i.enableMenu, u, hr(t)), f = s;
	...
	getNextTabbedCellForwards(e) {
		...
		if (!o) {
			...
			if (R(t) || !t.rowPinned && !(n?.isRowInPage(t.rowIndex) ?? !0)) return null;
	...
	getNextTabbedCellBackwards(e) {
		...
		if (!s) {
			...
			if (R(n) || !n.rowPinned && !(r?.isRowInPage(n.rowIndex) ?? !0)) return null;
...
function Sp(e, t = {}) {
	...
	if (n) return n;
	let o = e.colModel.getCol(r ?? i ?? Cp(a)), s = t.rowCtrl ?? xp(e, t), c = s?.getCellCtrl(o) ?? void 0;
	if (c) return c;
...
var wp = Symbol("unedited");
function Tp(e, t, n) {
	let r = { editorValueExists: !1 };
	if (Mp(e) && (t.getValidationErrors?.()?.length ?? 0) > 0 || n?.isCancelling) return r;
	if (n?.isStopping) {
...
function Ep(e, t) {
	for (let n of e.editModelSvc?.getEditPositions() ?? []) {
		...
		if (!i) continue;
		let { editorValue: a, editorValueExists: o, isCancelAfterEnd: s } = Tp(e, i, t);
		if (s) {
...
function Dp(e, t, n, r, i, a) {
	...
	if (u?.sourceValue === void 0) {
		let n = u ? Op(e, u.editorValue, !1, l) : wp, r = {
			sourceValue: s.getValue(l, c, "data"),
			pendingValue: n
		};
		a?.persist && (r.state = "changed"), u = o.setEdit(t, r);
	}
	o.setEdit(t, { editorValue: i ? Op(e, u.sourceValue, !0, l) : n }), a?.persist && kp(e, t);
}
function Op(e, t, n, r) {
	let { formula: i } = e;
...
function kp(e, t) {
	let { editModelSvc: n } = e, r = n?.getEdit(t), i = { pendingValue: Op(e, r?.editorValue, !1, t.column) };
...
function Mp(e) {
	return !!e.gos.get("getFullRowEditValidationErrors") || Ap(e.colModel.getColumnDefs()) || jp(e);
}
function Np(e, t) {
	if (!(t || Mp(e))) return;
	let n = new yp(), { ariaAnnounce: r, localeSvc: i, editModelSvc: a, gos: o } = e, s = o.get("editType") === "fullRow", c = Mt(i)("ariaValidationErrorPrefix", "Cell Editor Validation"), l = /* @__PURE__ */ new Set();
	for (let t of e.rowRenderer.getCellCtrls()) {
		let e = t.comp?.getCellEditor();
		if (!e) continue;
		let i = vp(e), { rowNode: a, column: o } = t, s = i.getValidationErrors?.() ?? [], u = i.getValidationElement?.(!1) || !i.isPopup?.() && t.eGui;
		if (u) {
	...
	if (Ep(e, { persist: !1 }), a?.setCellValidationModel(n), s) {
		let t = Pp(e);
...
var Pp = (e) => {
	let t = new bp(), n = e.gos.get("getFullRowEditValidationErrors"), r = e.editModelSvc?.getEditMap();
	if (!r) return t;
	for (let e of r.keys()) {
		let i = r.get(e);
		if (!i) continue;
		...
		for (let e of i.keys()) {
			let t = i.get(e);
			if (!t) continue;
			let { editorValue: n, pendingValue: r, sourceValue: c } = t, l = n ?? (r === wp ? void 0 : r) ?? c;
			a.push({
				column: e,
				colId: e.getColId(),
				rowIndex: o,
...
function Ip(e, t, n, { rowNode: r, column: i }, a) {
	return K(e.gos, {
		type: n,
		node: r,
		data: r.data,
...
var Rp = class extends H {
	...
	onBackspaceOrDeleteKeyDown(e, t) {
		...
		if (s.dispatchEvent({ type: "keyShortcutChangedCellStart" }), Lp(e, a.get("enableCellEditingOnBackspace")) && !c?.isEditing(n, { withOpenEditor: !0 })) {
	...
	onEnterKeyDown(e) {
		...
		if (a || s) {
			...
			if (Np(n), r?.checkNavWithValidation(void 0, e) === "block-stop") return;
	...
	onF2KeyDown(e) {
		...
		n?.isEditing() && (Np(this.beans), n?.checkNavWithValidation(void 0, e) === "block-stop") || n?.startEditing(t, {
			startedEdit: !0,
			event: e
		});
	}
	...
	getColSpanningList() {
		...
		if (n === 1) r.push(e);
			...
			for (let e = 0; t && e < n && (r.push(t), t = this.beans.visibleCols.getColAfter(t), !(!t || R(t) || i !== t.getPinned())); e++);
		}
		return r;
	}
	onLeftChanged() {
...
}, Vp = "ag-cell", Hp = "ag-cell-auto-height", Up = "ag-cell-normal-height", Wp = "ag-cell-focus", Gp = "ag-cell-first-right-pinned", Kp = "ag-cell-last-left-pinned", qp = "ag-cell-not-inline-editing", Jp = "ag-cell-wrap-text", Yp = 0, Xp = class extends H {
	constructor(e, t, n, r) {
		...
		let { colId: i } = e;
		this.instanceId = i + "-" + Yp++, this.createCellPosition(), this.updateAndFormatValue(!1);
	}
	addFeatures() {
		let { beans: e } = this;
		this.positionFeature = new Bp(this, e), this.customStyleFeature = e.cellStyles?.createCellCustomStyleFeature(this), this.editStyleFeature = e.editSvc?.createCellStyleFeature(this), this.mouseListener = new zp(this, e, this.column), this.keyboardListener = new Rp(this, e, this.rowNode, this.rowCtrl), this.enableTooltipFeature();
		let { rangeSvc: t } = e;
	...
	enableEditorTooltipFeature(e) {
		this.editorTooltipFeature && this.disableEditorTooltipFeature(), this.editorTooltipFeature = this.beans.tooltipSvc?.setupCellEditorTooltip(this, e), Np(this.beans);
	}
	...
	isIncludeControl(e, t = !1) {
		return (this.rowNode.rowPinned == null || t && Fp(this.rowNode)) && !!e;
	}
	...
	onCellFocused(e) {
		...
		if (this.comp.toggleCss(Wp, n), n && (e?.forceBrowserFocus || !this.hasBrowserFocus() && this.beans.focusSvc.shouldTakeFocus())) {
	...
	applyStaticCssClasses() {
		let { comp: e } = this;
		e.toggleCss(Vp, !0), e.toggleCss(qp, !0);
		let t = this.column.isAutoHeight() == 1;
		e.toggleCss(Hp, t), e.toggleCss(Up, !t);
	}
	onColumnHover() {
...
var Qp = 0, $p = class extends H {
	constructor(e, t, n, r, i) {
		super(), this.rowNode = e, this.useAnimationFrameForCreate = r, this.printLayout = i, this.focusEventWhileNotReady = null, this.allRowGuis = [], this.active = !0, this.centerCellCtrls = {
			...
			right: !1,
			fullWidth: !1
		}, this.rowDragComps = [], this.lastMouseDownOnDragger = !1, this.emptyStyle = {}, this.updateColumnListsPending = !1, this.rowId = null, this.ariaRowIndex = null, this.businessKey = null, this.beans = t, this.gos = t.gos, this.paginationPage = t.pagination?.getCurrentPage() ?? 0, this.suppressRowTransform = this.gos.get("suppressRowTransform"), this.instanceId = e.id + "-" + Qp++, this.rowId = ue(e.id), this.initRowBusinessKey(), this.rowFocused = t.focusSvc.isRowFocused(this.rowNode.rowIndex, this.rowNode.rowPinned), this.rowLevel = Zp(this.rowNode), this.setRowType(), this.setAnimateFlags(n), this.rowStyles = this.processStylesFromGridOptions(), this.rowEditStyleFeature = t.editSvc?.createRowStyleFeature(this), this.addListeners();
	}
	initRowBusinessKey() {
	...
	getNewCellCtrl(e) {
		if (!this.beans.rowSpanSvc?.isCellSpanning(e, this.rowNode)) return new Xp(e, this.rowNode, this.beans, this);
	}
	...
	setAnimateFlags(e) {
		...
		let t = L(this.rowNode.oldRowTop), { visibleCols: n } = this.beans, r = n.isPinningLeft(), i = n.isPinningRight();
		if (t) {
	...
	getRowPosition() {
		return {
			rowPinned: I(this.rowNode.rowPinned),
			rowIndex: this.rowNode.rowIndex
		};
	}
	...
	navigateTo({ scrollIndex: e, scrollType: t, scrollColumn: n, focusIndex: r, focusColumn: i, isAsync: a, rowPinned: o }) {
		...
		L(n) && !n.isPinned() && s.ensureColumnVisible(n), L(e) && s.ensureIndexVisible(e, t), a || s.ensureIndexVisible(r);
	...
	onPageDown(e) {
		let t = this.beans, n = tm(t), r = this.getViewportHeight(), { pageBounds: i, rowModel: a, rowAutoHeight: o } = t, s = i.getPixelOffset(), c = n.top + r, l = a.getRowIndexAtPixel(c + s);
		o?.active ? this.navigateToNextPageWithAutoHeight(e, l) : this.navigateToNextPage(e, l);
	}
	onPageUp(e) {
		let t = this.beans, n = tm(t), { pageBounds: r, rowModel: i, rowAutoHeight: a } = t, o = r.getPixelOffset(), s = n.top, c = i.getRowIndexAtPixel(s + o);
	...
	getViewportHeight() {
		let e = this.beans, t = tm(e), n = this.beans.scrollVisibleSvc.getScrollbarWidth(), r = t.bottom - t.top;
	...
	onTabKeyDown(e, t) {
		...
		} else e instanceof Xp && e.focusCell(!0), (s.focusOverlay(!1) || io(i, n)) && t.preventDefault();
	}
	tabToNextCell(e, t) {
	...
	tabToNextCellCommon(e, t, n, r = "ui") {
		let { editSvc: i, focusSvc: a } = this.beans, o, s = e instanceof Xp ? e : e.getAllCellCtrls()?.[0];
	...
	moveToNextCellNotEditing(e, t, n) {
		...
		if (a === !1) return null;
		if (a instanceof Xp) a.focusCell(!0);
	...
	navigateToNextCell(e, t, n, r) {
		...
		for (; i && (i === n || !this.isValidNavigateCell(i));) l.get("enableRtl") ? t === Y.LEFT && (i = this.getLastCellOfColSpan(i)) : t === Y.RIGHT && (i = this.getLastCellOfColSpan(i)), i = s.getNextCellToFocus(t, i), a = R(i);
		if (a && e && e.key === Y.UP && (i = {
			rowIndex: -1,
			rowPinned: null,
			column: n.column
	...
	ensureCellVisible(e) {
		...
		!r && R(e.rowPinned) && i.ensureIndexVisible(e.rowIndex), e.column.isPinned() || i.ensureColumnVisible(e.column);
	}
...
var nm = {
...
}, am = ".ag-pinned-left-floating-bottom,.ag-pinned-left-floating-top,.ag-pinned-right-floating-bottom,.ag-pinned-right-floating-top{min-width:0;overflow:hidden;position:relative}.ag-pinned-left-sticky-top,.ag-pinned-right-sticky-top{height:100%;overflow:hidden;position:relative}.ag-sticky-bottom-full-width-container,.ag-sticky-top-full-width-container{height:100%;overflow:hidden;width:100%}.ag-pinned-left-header,.ag-pinned-right-header{display:inline-block;height:100%;overflow:hidden;position:relative}.ag-body-horizontal-scroll:not(.ag-scrollbar-invisible){.ag-horizontal-left-spacer:not(.ag-scroller-corner){border-right:var(--ag-pinned-column-border)}.ag-horizontal-right-spacer:not(.ag-scroller-corner){border-left:var(--ag-pinned-column-border)}}.ag-pinned-right-header{border-left:var(--ag-pinned-column-border)}.ag-pinned-left-header{border-right:var(--ag-pinned-column-border)}.ag-cell.ag-cell-first-right-pinned:not(.ag-cell-range-left,.ag-cell-range-single-cell,.ag-cell-focus:not(.ag-cell-range-selected):focus-within){border-left:var(--ag-pinned-column-border)}.ag-cell.ag-cell-last-left-pinned:not(.ag-cell-range-right,.ag-cell-range-single-cell,.ag-cell-focus:not(.ag-cell-range-selected):focus-within){border-right:var(--ag-pinned-column-border)}.ag-pinned-left-header .ag-header-cell-resize:after{left:calc(50% - var(--ag-header-column-resize-handle-width))}.ag-pinned-right-header .ag-header-cell-resize:after{left:50%}.ag-pinned-left-header .ag-header-cell-resize{right:-3px}.ag-pinned-right-header .ag-header-cell-resize{left:-3px}", om = class extends H {
	constructor(e, t) {
	...
	postConstruct() {
		let e = this.beans, t = B(e), n = this.descriptionContainer = t.createElement("div");
		n.classList.add("ag-aria-description-container"), Oe(n, "polite"), Ae(n, "additions text"), ke(n, !0), e.eRootDiv.appendChild(n);
	}
	announceValue(e, t) {
	...
	moduleName: "Aria",
	version: U,
	beans: [class extends cm {}]
}, um = ":where(.ag-delay-render){.ag-cell,.ag-header-cell,.ag-header-group-cell,.ag-row,.ag-spanned-cell-wrapper{visibility:hidden}}", dm = "ag-delay-render", fm = {
	...
	beans: [class extends H {
		...
		hideColumns(e) {
			this.alreadyRevealed || this.requesters.has(e) || (this.requesters.add(e), this.hideRequested ||= (this.beans.ctrlsSvc.whenReady(this, (e) => {
				e.gridBodyCtrl.eGridBody.classList.add(dm);
			}), !0));
		}
		revealColumns(e) {
			...
			n.getGridBodyCtrl().eGridBody.classList.remove(dm), this.alreadyRevealed = !0;
		}
	}],
	css: [um]
}, pm = class extends Qi {
	...
	init(e) {
		let { beans: t, gos: n } = this, r = I(n.get("overlayLoadingTemplate")?.trim());
		if (this.setTemplate(r ?? gm), !r) {
	...
	init(e) {
		let { beans: t, gos: n } = this, r = I(n.get("overlayNoRowsTemplate")?.trim());
		if (this.setTemplate(r ?? bm), !r) {
...
var Tm = ".ag-overlay{inset:0;pointer-events:none;position:absolute;z-index:2}.ag-overlay-panel,.ag-overlay-wrapper{display:flex;height:100%;width:100%}.ag-overlay-wrapper{align-items:center;flex:none;justify-content:center;text-align:center}.ag-overlay-exporting-wrapper,.ag-overlay-loading-wrapper,.ag-overlay-modal-wrapper{pointer-events:all}.ag-overlay-exporting-center,.ag-overlay-loading-center{background:var(--ag-background-color);border:solid var(--ag-border-width) var(--ag-border-color);border-radius:var(--ag-border-radius);box-shadow:var(--ag-popup-shadow);display:flex;padding:var(--ag-spacing)}", Em = {
	tag: "div",
	cls: "ag-overlay",
	role: "presentation",
	children: [{
	...
	constructor() {
		super(Em), this.eOverlayWrapper = null, this.activeOverlay = null, this.activePromise = null, this.activeCssClass = null, this.elToFocusAfter = null, this.overlayExclusive = !1, this.oldWrapperPadding = null, this.registerCSS(Tm);
	}
	handleKeyDown(e) {
	...
	id: "agLoadingOverlay",
	overlayType: "loading",
	comp: Am("loadingOverlayComponent"),
	...
	id: "agNoRowsOverlay",
	overlayType: "noRows",
	comp: Am("noRowsOverlayComponent"),
	...
	userComponents: {
		agLoadingOverlay: _m,
		agNoRowsOverlay: xm,
		agNoMatchingRowsOverlay: ym,
		agExportingOverlay: hm
	},
	apiFunctions: {
		showLoadingOverlay: Sm,
		showNoRowsOverlay: Cm,
		hideOverlay: wm
	},
	icons: {
	...
	beans: [class extends H {
		...
		showLoadingOverlay() {
			...
			let e = this.gos;
			if (!this.eWrapper || e.get("activeOverlay") || this.isDisabled(jm)) return;
			let t = e.get("loading");
			!t && t !== void 0 || this.doShowOverlay(jm);
		}
		showNoRowsOverlay() {
			this.showInitialOverlay = !1;
			let e = this.gos;
			!this.eWrapper || e.get("activeOverlay") || e.get("loading") || this.isDisabled(Mm) || (this.userForcedNoRows = !0, this.doShowOverlay(Mm));
		}
		async showExportOverlay(e) {
			let { gos: t, beans: n } = this;
			if (!this.eWrapper || t.get("activeOverlay") || t.get("loading") || this.isDisabled(Pm) || this.userForcedNoRows && this.currentDef === Mm) {
				e();
				return;
			}
			let r = this.getDesiredDefWithOverride(Pm);
			if (!r) {
				e();
				return;
			}
		...
		hideOverlay() {
			...
			if (this.currentDef === Nm) {
				W(297);
				return;
			}
			this.doHideOverlay(), t && this.getOverlayDef() !== Mm && this.updateOverlay(!1);
		}
		...
		onPropChange(e) {
			...
			if (r && n) {
				...
				if (n === Fm) t && r.refresh?.(this.makeCompParams(!0));
				else {
					let t = n.paramsKey;
		...
		updateOverlay(e) {
			...
			return n === this.currentDef ? n === Fm && e && n ? (t.hideOverlay(), this.doShowOverlay(n), !0) : (n || this.disableInitialOverlay(), !1) : n ? (this.doShowOverlay(n), !0) : (this.disableInitialOverlay(), this.doHideOverlay());
		}
		getDesiredDefWithOverride(e) {
			let { gos: t } = this, n = Im(t.get("activeOverlay"));
			return n || (n = e ?? this.getOverlayDef(), n && this.isDisabled(n) && (n = null)), n;
		}
		getOverlayDef() {
			let { gos: e, beans: t } = this, { rowModel: n } = t, r = e.get("loading");
			if (r !== void 0) {
				if (this.disableInitialOverlay(), r) return jm;
			} else if (this.showInitialOverlay) {
				if (!this.isDisabled(jm) && (!e.get("columnDefs") || !e.get("rowData"))) return jm;
				this.disableInitialOverlay();
			} else this.disableInitialOverlay();
			return Lm(n.getOverlayType());
		}
	...
	refreshFloatingRows(e, t, n) {
		...
		r?.forEachPinnedRow(t, (s, c) => {
			let l = e[c];
			l && r.getPinnedRowById(l.rowNode.id, t) === void 0 && (l.destroyFirstPass(), l.destroySecondPass()), s.id in o && n ? (e[c] = o[s.id], delete o[s.id]) : e[c] = new $p(s, i, !1, !1, a);
	...
	getRowCtrls(e) {
		let t = Um(e), n = this.getAllRowCtrls();
	...
	getFullWidthRowCtrls(e) {
		...
		return this.getAllRowCtrls().filter((e) => {
			...
			let n = e.rowNode;
			return !(t != null && !Wm(n, t));
		});
	}
	createOrUpdateRowCtrl(e, t, n, r) {
		let i, a = this.rowCtrlsByRowIndex[e];
		if (a || (i = this.rowModel.getRow(e), L(i) && L(t) && t[i.id] && i.alreadyRendered && (a = t[i.id], t[i.id] = null)), !a) if (i ||= this.rowModel.getRow(e), L(i)) a = this.createRowCon(i, n, r);
		else return;
	...
	createRowCon(e, t, n) {
		...
		return new $p(e, this.beans, t, i, this.printLayout);
	}
	getRenderedNodes() {
	...
	removeRow(e) {
		...
		delete this.entriesMap[t], F(this.entriesList, n);
	}
	removeFromCache(e) {
		let t = e.rowNode.id;
		delete this.entriesMap[t], F(this.entriesList, e);
	}
	getEntries() {
...
var Gm = class extends H {
	...
	postConstruct() {
		this.firstLeaf = Un(this.gos) ? Mc : Km, this.addManagedPropertyListeners([
			"accentedSort",
			"autoGroupColumnDef",
			"treeData"
	...
	compareRowNodes(e, t, n) {
		...
		for (let i = 0, a = e.length; i < a; ++i) {
			...
			if (u ? l = u(s, c, t, n, o) : (a.type === "absolute" && (s = qm(s), c = qm(c)), l = ae(s, c, r)), l) return a.sort === "asc" ? l : -l;
		}
		return 0;
	}
	getComparator(e, t) {
...
var Ym = (e, t) => ({
	...
	children: [
		Ym("Order", "order"),
		Ym("Asc", "ascending-icon"),
		Ym("Desc", "descending-icon"),
		Ym("Mixed", "mixed-icon"),
		Ym("AbsoluteAsc", "absolute-ascending-icon"),
		Ym("AbsoluteDesc", "absolute-descending-icon"),
		Ym("None", "none-icon")
	]
}, Zm = class extends Qi {
	constructor(e) {
		super(), this.eSortOrder = null, this.eSortAsc = null, this.eSortDesc = null, this.eSortMixed = null, this.eSortNone = null, this.eSortAbsoluteAsc = null, this.eSortAbsoluteDesc = null, e || this.setTemplate(Xm);
	}
	...
	apiFunctions: { onSortChanged: Jm },
	userComponents: { agSortIndicator: Zm },
	icons: {
		sortAscending: "asc",
		sortDescending: "desc",
		sortUnSort: "none",
	...
	endDeferred() {
		...
		if (t) for (let e of t) rh(n, e);
		if (e) {
			let t = e.getSortedRows();
			for (let e = 0, r = t.length; e < r; ++e) rh(n, t[e]);
		}
	...
	onCellValueChanged(e) {
		...
		if (e.source === th || t.get("suppressChangeDetection") || !n.rootNode) return;
	...
	beans: [
		...
		class extends H {
			...
			getDeleteValue(e, t) {
				return L(e.getColDef().valueParser) ? this.parseValue(e, t, "", this.getValueForDisplay({
					column: e,
					node: t,
					from: "edit"
				}).value) ?? null : null;
			...
			isSetValueSupported(e, t, n, r) {
				...
				return R(i) && R(a) && !(c && s) ? t.group && (r.groupRowValueSetter || r.groupRowEditable) ? !0 : (W(17), !1) : this.dataTypeSvc && !this.dataTypeSvc.checkType(e, n) ? (W(135), !1) : !0;
			}
			...
			computeValueChange(e) {
				...
				return L(t) ? typeof t == "function" ? t(n) : this.expressionSvc?.evaluate(t, n) : !!r && this.setValueUsingField(r, i, o, a.isFieldContainsDots());
			}
...
[...ah], [...ah];
var oh = () => "No AG Grid modules are registered! It is recommended to start with all Community features via the AllCommunityModule:\n                    \n    import { ModuleRegistry, AllCommunityModule } from 'ag-grid-community';\n    \n    ModuleRegistry.registerModules([ AllCommunityModule ]);\n    ";
function sh({ moduleName: e, rowModelType: t }) {
...
}, lh = /* @__PURE__ */ new WeakMap(), uh = /* @__PURE__ */ new WeakMap(), dh = 1, fh = class {
	create(e, t, n, r, i, a) {
		let o = Yt.applyGlobalGridOptions(t), s = o.gridId ?? String(dh++), c = this.getRegisteredModules(i, s, o.rowModelType), l = this.createBeansList(o.rowModelType, c, s), u = this.createProvidedBeans(e, o, i);
		if (!l) return;
		let d = new Ba({
			...
			derivedBeans: [Va],
			destroyCallback: () => {
				uh.delete(f), lh.delete(e), hn(s), a?.();
			}
		});
		this.registerModuleFeatures(d, c), n(d), d.getBean("syncSvc").start(), r?.(d);
		let f = d.getBean("gridApi");
		return lh.set(e, f), uh.set(f, e), f;
	}
	getRegisteredModules(e, t, n) {
		return mn(ih, void 0, !0), e?.modules?.forEach((e) => mn(e, t)), vn(t, ph(n));
	}
...
var mh = class {
...
}, $ = c.createContext({}), gh = c.createContext("default"), _h = (e, t, n, r) => {
	...
	return i.then((e) => {
		...
		a = e, o = a.getGui(), n.appendChild(o), vh(r, a);
	}), () => {
		s = !0, a && (o?.remove(), t.destroyBean(a), r && vh(r, void 0));
	};
}, vh = (e, t) => {
...
}, yh = (...e) => e.filter((e) => e != null && e !== "").join(" "), bh = class e {
	constructor(...e) {
		this.classesMap = {};
...
}, xh = (e) => typeof e == "function" && !(e.prototype && e.prototype.isReactComponent) || typeof e == "object" && e.$$typeof === (typeof Symbol == "function" && Symbol.for ? Symbol.for("react.memo") : 60115), Sh = c.version?.split(".")[0], Ch = Sh === "16" || Sh === "17";
function wh() {
	return Sh === "19";
}
var Th = !1;
function Eh(e) {
	return Th || setTimeout(() => Th = !1, 0), Th = !0, e();
}
var Dh = (e, t) => {
	!Ch && e && !Th ? w.flushSync(t) : t();
}, Oh = (e) => {
	Ch ? e() : c.startTransition(e);
};
function kh(e, t, n) {
...
var jh = p((e, t) => {
	let { registry: n, context: r } = g($), i = x(null), a = x(null), o = x(null), s = x(null), l = x(null), u = x(), [d, f] = S(), [p, m] = S(), [_, C] = S(), [w, T] = S(() => new bh()), [E, D] = S(() => new bh("ag-hidden")), [ee, O] = S(() => new bh("ag-hidden")), [k, A] = S(() => new bh("ag-invisible"));
	v(t, () => ({ refresh() {
		return !1;
	} })), y(() => _h(d, r, a.current), [d]);
	let te = h((t) => {
		...
		c && (u.current = r.createBean(c), u.current.init(a, t, o.current, s.current, l.current, jh, e));
	}, []), ne = b(() => `ag-cell-wrapper ${w.toString()}`, [w]), j = b(() => `ag-group-expanded ${E.toString()}`, [E]), M = b(() => `ag-group-contracted ${ee.toString()}`, [ee]), N = b(() => `ag-group-checkbox ${k.toString()}`, [k]), P = d?.componentFromFramework, F = P ? d.componentClass : void 0, re = d == null && _ != null, I = le(_);
	return /* @__PURE__ */ c.createElement("span", {
		...
		ref: a
	}, re ? I : P ? /* @__PURE__ */ c.createElement(F, { ...d.params }) : null), /* @__PURE__ */ c.createElement("span", { className: "ag-group-child-count" }, p));
}), Mh = jh, Nh = d({ setMethods: () => {} }), Ph = m((e) => {
	let { initialProps: t, addUpdateCallback: n, CustomComponentClass: r, setMethods: i } = e, [{ key: a, ...o }, s] = S(t);
	return _(() => {
		n((e) => s(e));
	}, []), /* @__PURE__ */ c.createElement(Nh.Provider, { value: { setMethods: i } }, /* @__PURE__ */ c.createElement(r, {
		key: a,
		...o
	}));
}), Fh = 0;
function Ih() {
	return `agPortalKey_${++Fh}`;
}
var Lh = class {
	constructor(e, t, n, r) {
		this.portal = null, this.oldPortal = null, this.reactComponent = e, this.portalManager = t, this.componentType = n, this.suppressFallbackMethods = !!r, this.statelessComponent = this.isStateless(this.reactComponent), this.key = Ih(), this.portalKey = Ih(), this.instanceCreated = this.isStatelessComponent() ? X.resolve(!1) : new X((e) => {
...
var zh = class extends Lh {
	...
	setMethods(e) {
		this.providedMethods = e, Rh(this.getOptionalMethods(), this.providedMethods, this);
	}
	getOptionalMethods() {
		return [];
	}
...
var qh = class {
	...
	setMethods(e) {
		Rh(this.getOptionalMethods(), e, this);
	}
	getOptionalMethods() {
		return ["afterGuiAttached"];
	}
	updateModel(e) {
		this.model = e, this.refreshProps(), Kh(this.floatingFilterParams, e);
	}
}, Jh = class extends zh {
	constructor() {
	...
	updateModel(e) {
		this.model = e, this.refreshProps(), Kh(this.sourceParams, e);
	}
	getProps() {
		let e = super.getProps();
...
var tg = 1e3, ng = class {
	constructor(e, t, n) {
		this.destroyed = !1, this.portals = [], this.hasPendingPortalUpdate = !1, this.wrappingElement = t || "div", this.refresher = e, this.maxComponentCreationTimeMs = n || tg;
	}
	getPortals() {
		return this.portals;
	}
	...
	waitForInstance(e, t, n = Date.now()) {
		...
		if (e.rendered()) t(e);
			...
			if (Date.now() - n >= this.maxComponentCreationTimeMs && !this.hasPendingPortalUpdate) {
				Dh(!0, () => this.refresher()), e.rendered() && t(e);
				return;
			}
			window.setTimeout(() => {
...
}, rg = c.createContext([]), ig = c.createContext(void 0), ag = m(({ ctrl: e }) => {
	...
	y(() => _h(r, n, d.current, f), [r]), _(() => {
		e.setDragSource(l.current);
	}, [r]);
	let v = b(() => !!(r?.componentFromFramework && xh(r.componentClass)), [r]), C = r?.componentFromFramework, w = r?.componentClass;
	...
	let { context: t, gos: n } = g($), [r, i] = S(), [a, o] = S(() => new bh("ag-header-cell", "ag-floating-filter")), [s, l] = S(() => new bh()), [u, d] = S(() => new bh("ag-floating-filter-button", "ag-hidden")), [f, p] = S("false"), [m, v] = S(), [, C] = S(1), w = x(), T = x(null), E = x(null), D = x(null), ee = x(null), O = x(), k = x(), A = (e) => {
		e != null && O.current?.(e);
	}, te = h((n) => {
	...
	y(() => _h(m, t, E.current, A), [m]);
	let ne = b(() => a.toString(), [a]), j = b(() => s.toString(), [s]), M = b(() => u.toString(), [u]), N = b(() => !!(m && m.componentFromFramework && xh(m.componentClass)), [m]), P = b(() => n.get("reactiveCustomComponents"), []), F = b(() => n.get("enableFilterHandlers"), []), [re, I] = S();
	_(() => {
		if (m?.componentFromFramework) if (P) {
			let e = new (F ? og : qh)(m.params, () => C((e) => e + 1));
			A(e), I(e);
		} else eg();
	}, [m]);
	let L = re?.getProps(), R = m?.componentFromFramework, ie = m?.componentClass;
	return /* @__PURE__ */ c.createElement("div", {
		ref: te,
		style: r,
		className: ne,
		...
		className: j,
		role: "presentation"
	}, R ? P ? L && /* @__PURE__ */ c.createElement(Nh.Provider, { value: { setMethods: (e) => re.setMethods(e) } }, /* @__PURE__ */ c.createElement(ie, { ...L })) : /* @__PURE__ */ c.createElement(ie, {
		...m.params,
		ref: N ? () => {} : A
	...
	let { context: t } = g($), [n, r] = S(), [i, a] = S(() => new bh()), [o, s] = S(() => new bh()), [l, u] = S("false"), [d, f] = S(), [p, m] = S(), v = x(), C = x(null), w = x(null), T = x(null), E = x(), D = h((n) => {
	...
	y(() => _h(p, t, T.current), [p]), _(() => {
		C.current && e.setDragSource(C.current);
	}, [p]);
	let ee = b(() => !!(p?.componentFromFramework && xh(p.componentClass)), [p]), O = b(() => "ag-header-group-cell " + i.toString(), [i]), k = b(() => "ag-header-cell-resize " + o.toString(), [o]), A = p?.componentFromFramework, te = p?.componentClass;
	return /* @__PURE__ */ c.createElement("div", {
		ref: D,
		style: n,
		className: O,
	...
	let { gos: t, context: n } = g($), { topOffset: r, rowHeight: i } = b(() => e.getTopAndHeight(), []), a = b(() => t.get("tabIndex"), []), [o, s] = S(() => e.getAriaRowIndex()), l = e.headerRowClass, [u, d] = S(() => i + "px"), [f, p] = S(() => r + "px"), m = x(null), [_, v] = S(() => e.getUpdatedHeaderCtrls()), y = x(), C = x(null), w = h((t) => {
		...
		y.current = n.createBean(new So()), e.setComp({
			...
			setHeaderCtrls: (e, t, n) => {
				let r = m.current, i = Ah(r, e, t);
				i !== r && (m.current = i, Dh(n, () => v(i)));
			},
			setWidth: (e) => {
				C.current && (C.current.style.width = e);
			},
		...
		switch (e.type) {
			case "group": return /* @__PURE__ */ c.createElement(cg, {
				ctrl: t,
				key: t.instanceId
			});
			case "filter": return /* @__PURE__ */ c.createElement(sg, {
				ctrl: t,
				key: t.instanceId
			});
			default: return /* @__PURE__ */ c.createElement(ag, {
				ctrl: t,
				key: t.instanceId
			});
		}
	...
	}, []), m = t ? "" : "ag-hidden", _ = () => r.map((e) => /* @__PURE__ */ c.createElement(lg, {
		ctrl: e,
		key: e.instanceId
	}));
	...
	let [e, t] = S(() => new bh()), [n, r] = S(), { context: i } = g($), a = x(null), o = x(), s = h((e) => {
	...
	return /* @__PURE__ */ c.createElement("div", {
		...
		style: u,
		role: "presentation"
	}, /* @__PURE__ */ c.createElement(ug, { pinned: "left" }), /* @__PURE__ */ c.createElement(ug, { pinned: null }), /* @__PURE__ */ c.createElement(ug, { pinned: "right" }));
}), fg = (e, t) => {
	_(() => {
		let n = t.current;
		if (n) {
	...
	let { compProxy: r } = e;
	n(r);
	let i = r.getProps(), a = xh(t);
	return /* @__PURE__ */ c.createElement(Nh.Provider, { value: { setMethods: (e) => r.setMethods(e) } }, a ? /* @__PURE__ */ c.createElement(t, { ...i }) : /* @__PURE__ */ c.createElement(t, {
		...i,
		ref: (e) => r.setRef(e)
	}));
}, _g = (e, t, n) => e.compProxy ? gg(e, t, n) : /* @__PURE__ */ c.createElement(t, {
	...
	return s ? _g(e, o, t) : l ? /* @__PURE__ */ c.createElement(hg, {
		editDetails: e,
		cellCtrl: r,
		eParentCell: n,
		wrappedContent: _g(e, o, t)
	}) : u && i ? /* @__PURE__ */ c.createElement(hg, {
		editDetails: e,
		cellCtrl: r,
		eParentCell: n,
		jsChildComp: i
	...
	if (yg(r, !1, void 0, 1, n, t), r?.compDetails?.componentFromFramework) {
...
}, xg = m(({ cellCtrl: e, printLayout: t, editingCell: n }) => {
	let { context: r } = g($), { column: { colIdSanitised: i }, instanceId: a } = e, o = x(), [s, l] = S(() => e.isCellRenderer() ? void 0 : {
		compDetails: void 0,
		value: e.getValueToDisplay(),
		force: !1
	}), [d, f] = S(), [p, m] = S(1), [_, v] = S(), [C, w] = S(!1), [T, E] = S(!1), [D, ee] = S(!1), O = x(null), [k, A] = S(), te = b(() => e.isForceWrapper(), [e]), ne = b(() => e.getCellAriaRole(), [e]), j = x(null), M = x(null), N = x(null), P = x(), F = x(), re = x(), I = x([]), L = x(), R = x(), [ie, ae] = S(0), oe = h((e) => {
		R.current = e, ae((e) => e + 1);
	...
	y(() => {
		...
		return i.then((e) => {
			if (!e) return;
			let t = e.getGui();
			ue(e), n || ((te ? re : j).current?.appendChild(t), e.afterGuiAttached?.()), A(e);
		}), () => {
			i.then((t) => {
				let n = t.getGui();
	...
	let z = h((t) => {
		if (re.current = t, !t || r.isDestroyed() || !e.isAlive()) {
			let e = I.current;
			I.current = [];
			for (let t of e) t();
			return;
		...
		let n, i = (e) => {
			e && (t.insertAdjacentElement("afterbegin", e.getGui()), I.current.push(() => {
				tt(e.getGui()), r.destroyBean(e), L.current === n && (L.current = void 0);
			}));
		};
		C && i(e.createSelectionCheckbox()), D && i(e.createDndSource()), T && (n = e.createRowDragComp(), L.current = n, n && (i(n), n.refreshVisibility()));
	}, [
		e,
		r,
		D,
		...
		let s = {
			...
			getCellEditor: () => F.current ?? null,
			getCellRenderer: () => N.current ?? P.current,
			getParentOfValue: () => R.current ?? re.current ?? j.current,
			...
			setEditDetails: (t, n, r, i) => {
				if (t) {
					let e;
					t.componentFromFramework && (i ? e = new pg(t.params, () => m((e) => e + 1)) : eg()), f({
						compDetails: t,
						popup: n,
						popupPosition: r,
						compProxy: e
					}), n || l(void 0);
				} else e.hasBrowserFocus() && s.getFocusableElement().focus({ preventScroll: !0 }), F.current = void 0, f(void 0);
			},
		...
		M.current = e, B();
	}, []), ge = b(() => !!(s?.compDetails?.componentFromFramework && xh(s.compDetails.componentClass)), [s]);
	y(() => {
		if (!j.current) return;
		let { current: e } = de;
	...
	let _e = () => {
		...
		if (t.componentFromFramework) {
			...
			return /* @__PURE__ */ c.createElement(u, { fallback: /* @__PURE__ */ c.createElement(bg, {
				cellCtrl: e,
				parent: j
		...
		let t = () => s == null ? null : ce ? /* @__PURE__ */ c.createElement("span", {
			...
			className: le,
			ref: oe
		}, _e()) : _e(), n = (t) => vg(t, ue, j.current, e, k);
...
}), Sg = m(({ rowCtrl: e, containerType: t }) => {
	let { context: n, gos: r, editSvc: i } = g($), a = g(gh) === "default", o = x(), s = x(e.getDomOrder()), l = e.isFullWidth(), u = e.rowNode.displayed, [d, f] = S(() => u ? e.rowNode.getRowIndexString() : null), [p, m] = S(() => e.rowId), [v, C] = S(() => e.businessKey), [w, T] = S(() => e.rowStyles), E = x(null), [D, ee] = S(() => null), [O, k] = S(), [A, te] = S(() => u ? e.getInitialRowTop(t) : void 0), [ne, j] = S(() => u ? e.getInitialTransform(t) : void 0), M = x(null), N = x(), P = x(), F = x(!1), [re, I] = S(0);
	_(() => {
		if (F.current || !O || re > 10) return;
		let t = M.current?.firstChild;
		t ? (e.setupDetailRowAutoHeight(t), F.current = !0) : I((e) => e + 1);
	}, [O, re]);
	let L = x();
	L.current ||= new Ji(() => M.current);
	let R = x(() => {}), ie = kh(h((e) => (R.current = e, () => {
		R.current = () => {};
	}), []), () => E.current, []), ae = a ? ie : D, oe = h((r) => {
		...
		let i = {
			setTop: te,
			setTransform: j,
			toggleCss: (e, t) => L.current.toggleCss(e, t),
			...
			setUserStyles: T,
			setCellCtrls: (e, t) => {
				let n = E.current, r = Ah(n, e, s.current);
				r !== n && (E.current = r, a ? R.current() : Dh(t, () => ee(r)));
			},
			showFullWidth: (e) => {
	...
	let se = b(() => {
		...
		ne,
		w
	]), ce = l && O?.componentFromFramework, le = !l && ae != null, ue = b(() => !!(O?.componentFromFramework && xh(O.componentClass)), [O]), de = x(!1);
	return _(() => {
		de.current = ue && !!O && !!r.get("reactiveCustomComponents");
	}, [ue, O]), /* @__PURE__ */ c.createElement("div", {
		ref: oe,
		role: "row",
		style: se,
		"row-index": d,
		"row-id": p,
		"row-business-key": v
	}, le ? ae?.map((t) => /* @__PURE__ */ c.createElement(xg, {
		cellCtrl: t,
	...
	let { context: t, gos: n } = g($), r = b(() => ks(e), [e]), i = x(null), a = x(null), o = x(null), s = x([]), l = x([]), [u, d] = S(() => []), f = !!n.get("enableCellSpan") && !!r.getSpannedRowCtrls, p = x([]), m = x([]), [_, v] = S(() => []), y = x(!1), C = x(), w = b(() => yh("ag-viewport", Es(e)), [e]), T = b(() => yh(Ds(e)), [e]), E = b(() => yh("ag-spanning-container", Os(e)), [e]), D = r.type === "center" || f, ee = D ? i : a;
	fg(" AG Row Container " + e + " ", ee);
	let O = h(() => {
		...
		if (k() && (C.current = t.destroyBean(C.current)), !t.isDestroyed() && O()) {
			let n = (e) => {
				let t = Ah(l.current, s.current, y.current);
				t !== l.current && (l.current = t, Dh(e, () => d(t)));
			}, r = (e) => {
				let t = Ah(m.current, p.current, y.current);
				t !== m.current && (m.current = t, Dh(e, () => v(t)));
			};
	...
	}, u.map((e) => /* @__PURE__ */ c.createElement(Sg, {
		rowCtrl: e,
	...
	return D ? /* @__PURE__ */ c.createElement("div", {
		...
		ref: ne,
		role: "presentation"
	}, _.map((e) => /* @__PURE__ */ c.createElement(Sg, {
		rowCtrl: e,
		containerType: r.type,
		key: e.instanceId
	}))) : null) : M();
}), wg = m(() => {
	let e = g($), { context: t, overlays: n } = e, [r, i] = S(""), [a, o] = S(0), [s, l] = S(0), [u, d] = S("0px"), [f, p] = S("0px"), [m, _] = S("100%"), [v, y] = S("0px"), [C, w] = S("0px"), [T, E] = S("100%"), [D, ee] = S(!0), [O, k] = S(!0), [A, te] = S(null), [ne, j] = S(""), [M, N] = S(null), [P, F] = S("ag-layout-normal"), re = x();
	re.current ||= new Ji(() => I.current);
	let I = x(null), L = x(null), R = x(null), ie = x(null), ae = x(null), oe = x(null), se = x(null), ce = x([]), le = x([]);
	fg(" AG Grid Body ", I), fg(" AG Pinned Top ", L), fg(" AG Sticky Top ", R), fg(" AG Middle ", oe), fg(" AG Pinned Bottom ", se);
	let ue = h((r) => {
		if (I.current = r, !r || t.isDestroyed()) {
		...
		u && c(r, u, " AG Overlay Wrapper "), ae.current && c(ae.current, Ko, " AG Fake Vertical Scroll ");
		let f = {
			setRowAnimationCssOnBodyViewport: i,
			setColumnCount: (e) => {
				I.current && Ie(I.current, e);
			},
			setRowCount: (e) => {
				I.current && Pe(I.current, e);
			},
			setTopHeight: o,
			setBottomHeight: l,
			...
			setColumnMovingCss: (e, t) => re.current.toggleCss(e, t),
			...
			setBodyViewportWidth: (e) => {
				oe.current && (oe.current.style.width = e);
			},
			registerBodyViewportResizeListener: (t) => {
				if (oe.current) {
					let n = ft(e, oe.current, t);
					le.current.push(() => n());
				}
			},
		...
		ce.current.push(m), m.setComp(f, r, oe.current, L.current, se.current, R.current, ie.current);
	}, []), de = b(() => yh("ag-root", "ag-unselectable", P), [P]), fe = b(() => yh("ag-body-viewport", r, P, A, M), [
		r,
		P,
		A,
		M
	]), pe = b(() => yh("ag-body", P), [P]), z = b(() => yh("ag-floating-top", D ? "ag-invisible" : null, M), [M, D]), B = b(() => yh("ag-sticky-top", M), [M]), me = b(() => yh("ag-sticky-bottom", v === "0px" ? "ag-invisible" : null, M), [M, v]), he = b(() => yh("ag-floating-bottom", O ? "ag-invisible" : null, M), [M, O]), ge = b(() => ({
		height: a,
		minHeight: a,
		overflowY: ne
	}), [a, ne]), _e = b(() => ({
		...
		minHeight: s,
		overflowY: ne
	}), [s, ne]), be = (e) => /* @__PURE__ */ c.createElement(Cg, {
		name: e,
		key: `${e}-container`
	...
	return /* @__PURE__ */ c.createElement("div", {
		ref: ue,
		className: de
	}, /* @__PURE__ */ c.createElement(dg, null), xe({
		section: L,
		className: z,
		style: ge,
		children: [
	...
	let O = b(() => yh("ag-root-wrapper", t, r), [t, r]), k = b(() => yh("ag-root-wrapper-body", "ag-focus-managed", r), [r]), A = b(() => ({
		userSelect: s ?? "",
		WebkitUserSelect: s ?? "",
		cursor: a ?? ""
	}), [s, a]), te = h((e) => {
	...
	return /* @__PURE__ */ c.createElement("div", {
		...
		ref: C,
		role: "presentation"
	}, u && y && !e.isDestroyed() && /* @__PURE__ */ c.createElement($.Provider, { value: e.getBeans() }, /* @__PURE__ */ c.createElement(Tg, {
		ref: te,
		eFocusableElement: y,
		onTabKeyDown: D,
		gridCtrl: m.current,
		...
		isEmpty: ne
	}, /* @__PURE__ */ c.createElement(wg, null)))));
}), Dg = class extends H {
	postConstruct() {
	...
	...kg
}, jg = new Set(Object.keys(Ag)), Mg = new Set(Object.keys(kg)), Ng = (e) => {
	let t = g(rg), n = g(ig), r = x(), i = x(null), a = x(null), o = x([]), s = x([]), l = x(e), u = x(), d = x(), f = x(!1), [p, m] = S(void 0), [, v] = S(0), y = x(), C = (e) => {
	...
	let w = h((c) => {
		...
		let l = [...e.modules ?? [], ...t ?? []];
		n && Cn(l)?.setLicenseKey(n), a.current || (a.current = new ng(() => v((e) => e + 1), e.componentWrappingElement, e.maxComponentCreationTimeMs), o.current.push(() => {
			a.current?.destroy(), a.current = null;
		}));
		let p = _r(e.gridOptions, e, Object.keys(e).filter((e) => !jg.has(e))), h = new Lg(() => {
			if (f.current) {
		...
		let g = new Dg(), _ = {
			providedBeanInstances: {
				frameworkCompWrapper: new Fg(a.current, p),
				renderStatus: g
			},
			modules: l,
	...
	return /* @__PURE__ */ c.createElement("div", {
		style: T,
		ref: w
	}, /* @__PURE__ */ c.createElement(gh.Provider, { value: D }, p && !p.isDestroyed() ? /* @__PURE__ */ c.createElement(Eg, {
		key: p.instanceId,
		context: p
...
var Fg = class extends mh {
	...
	createWrapper(e, t) {
		...
		if (yr(n, "reactiveCustomComponents")) {
			let r = ((e) => {
				switch (e) {
					case "filter": return yr(n, "enableFilterHandlers") ? Gh : Wh;
					case "floatingFilterComponent": return yr(n, "enableFilterHandlers") ? Yh : Jh;
					case "dateComponent": return Hh;
					case "dragAndDropImageComponent": return Uh;
					case "loadingOverlayComponent":
					case "noRowsOverlayComponent":
					case "activeOverlay": return Vh;
					case "statusPanel": return Qh;
					case "toolPanel": return $h;
					case "menuItem": return Zh;
					case "cellRenderer": return Bh;
					case "innerHeaderComponent": return Xh;
				}
			})(t.name);
		...
		return new Lh(e, this.parent, t, r);
	}
}, Ig = p((e, t) => {
	let n = g($), { registry: r, context: i, gos: a, rowModel: o } = n, [s, l] = S(() => new bh()), [u, d] = S(() => new bh()), [f, p] = S(), [m, _] = S(), y = x(), C = x(null), w = x(), T = b(() => bn(e.api.getGridId(), f?.rowModelType ?? "clientSide"), [e]), E = b(() => s.toString() + " ag-details-row", [s]), D = b(() => u.toString() + " ag-details-grid", [u]);
	t && v(t, () => ({ refresh() {
	...
	constructor(e) {
		super("react"), this.processQueuedUpdates = e, this.queueUpdates = !1, this.renderingEngine = "react", this.frameworkComponents = {
			agGroupCellRenderer: Mh,
			agGroupRowRenderer: Mh,
			agDetailCellRenderer: Ig
		}, this.wrapIncoming = (e, t) => t === "ensureVisible" ? Eh(e) : e();
	}
	frameworkComponent(e) {
	...
	render() {
		return /* @__PURE__ */ c.createElement(Ng, {
			...this.props,
...
//#endregion
export { Bg as AgGridReactBase, E as Button, j as Checkbox, k as DatePicker, D as Input, A as InputNumber, te as RadioGroup, ee as Select, ne as Spin, O as TextArea };
