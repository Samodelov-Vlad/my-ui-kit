...
var Bf = class extends H {
	...
	constructor() {
		super(...arguments), this.beanName = "gos", this.domDataKey = "__AG_" + Math.random().toString(), this.instanceId = Xf++, this.gridReadyFired = !1, this.queueEvents = [], this.propEventSvc = new oe(), this.globalEventHandlerFactory = (e) => (t, n) => {
			if (!this.isAlive()) return;
			let r = Wf.has(t);
...
var np = class extends Qi {
	...
	setupLabel(e) {
		...
		L(t) && !a && (this.agLabel.textContent = le(t)), n.getColGroupDef()?.suppressStickyLabel || this.createManagedBean(new rp(this.getGui(), n));
	}
	destroy() {
	...
	beans: [class extends H {
		...
		setupForHeader(e) {
			...
			let c = e.shouldSuppressMenuHide(), l = c && L(a) && i.enableMenu, u = !!r?.isHeaderContextMenuEnabled(i.column), d = up(i.enableMenu, u, hr(t)), f = s;
...
var Km = class extends H {
	...
	compareRowNodes(e, t, n) {
		...
		for (let i = 0, a = e.length; i < a; ++i) {
			...
			if (u ? l = u(s, c, t, n, o) : (a.type === "absolute" && (s = Jm(s), c = Jm(c)), l = ae(s, c, r)), l) return a.sort === "asc" ? l : -l;
		}
		return 0;
	}
	getComparator(e, t) {
...
var ng = 1e3, rg = class {
	...
	let ne = b(() => a.toString(), [a]), j = b(() => s.toString(), [s]), M = b(() => u.toString(), [u]), N = b(() => !!(m && m.componentFromFramework && Sh(m.componentClass)), [m]), P = b(() => n.get("reactiveCustomComponents"), []), F = b(() => n.get("enableFilterHandlers"), []), [re, I] = S();
	_(() => {
		if (m?.componentFromFramework) if (P) {
			let e = new (F ? sg : Jh)(m.params, () => C((e) => e + 1));
			A(e), I(e);
		} else tg();
	}, [m]);
	...
	return /* @__PURE__ */ c.createElement("div", {
		...
		className: j,
		role: "presentation"
	}, R ? P ? L && /* @__PURE__ */ c.createElement(Ph.Provider, { value: { setMethods: (e) => re.setMethods(e) } }, /* @__PURE__ */ c.createElement(ie, { ...L })) : /* @__PURE__ */ c.createElement(ie, {
		...m.params,
		ref: N ? () => {} : A
	...
	let R = x(() => {}), ie = Ah(h((e) => (R.current = e, () => {
		...
		let i = {
			...
			setCellCtrls: (e, t) => {
				...
				r !== n && (E.current = r, a ? R.current() : Oh(t, () => ee(r)));
			},
			showFullWidth: (e) => {
	...
	let se = b(() => {
		...
		ne,
		w
	]), ce = l && O?.componentFromFramework, le = !l && ae != null, ue = b(() => !!(O?.componentFromFramework && Sh(O.componentClass)), [O]), de = x(!1);
	_(() => {
		de.current = ue && !!O && !!r.get("reactiveCustomComponents");
	}, [ue, O]);
	let fe = () => ae?.map((t) => /* @__PURE__ */ c.createElement(Sg, {
		cellCtrl: t,
	...
	pg(" AG Grid Body ", I), pg(" AG Pinned Top ", L), pg(" AG Sticky Top ", R), pg(" AG Middle ", oe), pg(" AG Pinned Bottom ", se);
	let ue = h((r) => {
